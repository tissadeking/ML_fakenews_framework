...
for mode in range(len(modell)):
    ...
    for npart in range(len(narr)):
        ...
        for ind in range(n):
            if ind == n - 1:
                partition = df[bin_edges[ind]:l + 1]
                dataarr.append(partition)
            elif ind <= n - 1:
                partition = df[bin_edges[ind]:bin_edges[ind + 1]]
                dataarr.append(partition)
        ...
        columns = ['model', 'number of partitions', 'validation accuracy', 'test accuracy', 'paramater 1', 'parameter 2', 'parameter 3', 'time elapsed (secs)',
            ...
            with open('results.csv', 'a') as csvfile:
                ...
                if model == 'pac':
                    datapar1 = {'model':'pac', 'number of partitions': n, 'validation accuracy': mean_accuracy,
                                ...
                                'parameter 2': bestparamarr['fit_intercept'], 'parameter 3': bestparamarr['loss'], 'time elapsed (secs)': t1t0,
                ...
                if model == 'log':
                    datapar2 = {'model':'log', 'number of partitions': n, 'validation accuracy': mean_accuracy,
                                'test accuracy': mean_testaccuracy, 'paramater 1': bestparamarr['C'],
                                'parameter 2': bestparamarr['penalty'], 'parameter 3': bestparamarr['solver'], 'time elapsed (secs)': t1t0,
                                'total traffic (bytes)': totaltraffic, 'inflow speed (bytes/sec)': receivespeed,
                                'outflow speed (bytes/sec)': sendspeed, 'memory usage (bytes)': sumcurrentusage}
                ...
                if model == 'mnb':
                    datapar3 = {'model':'mnb', 'number of partitions': n, 'validation accuracy': mean_accuracy,
                                ...
                                'parameter 2': bestparamarr['fit_prior'], 'time elapsed (secs)': t1t0, 'total traffic (bytes)': totaltraffic,
                ...
                if model == 'mlpc':
                    ...
                    datapar4 = {'model':'mlpc', 'number of partitions': n, 'validation accuracy': mean_accuracy,
                                ...
                                'parameter 2': hiddenlayerdata, 'parameter 3': bestparamarr['learning_rate'], 'time elapsed (secs)': t1t0,
                                'total traffic (bytes)': totaltraffic, 'inflow speed (bytes/sec)': receivespeed,
                                'outflow speed (bytes/sec)': sendspeed, 'memory usage (bytes)': sumcurrentusage}
                ...
                if model == 'svc':
                    datapar5 = {'model':'svc', 'number of partitions': n, 'validation accuracy': mean_accuracy,
                                'test accuracy': mean_testaccuracy, 'paramater 1': bestparamarr['C'],
                                'parameter 2': bestparamarr['gamma'], 'parameter 3': bestparamarr['kernel'], 'time elapsed (secs)': t1t0,
                                'total traffic (bytes)': totaltraffic, 'inflow speed (bytes/sec)': receivespeed,
                                'outflow speed (bytes/sec)': sendspeed, 'memory usage (bytes)': sumcurrentusage}
                ...
                if model == 'dt':
                    datapar6 = {'model':'dt', 'number of partitions': n, 'validation accuracy': mean_accuracy,
                                ...
                                'parameter 2': bestparamarr['max_depth'], 'parameter 3': bestparamarr['max_features'], 'time elapsed (secs)': t1t0,
                                'total traffic (bytes)': totaltraffic, 'inflow speed (bytes/sec)': receivespeed,
                                'outflow speed (bytes/sec)': sendspeed, 'memory usage (bytes)': sumcurrentusage}
                ...
                if model == 'kn':
                    datapar7 = {'model':'kn', 'number of partitions': n, 'validation accuracy': mean_accuracy,
                                ...
                                'parameter 2': bestparamarr['n_neighbors'], 'parameter 3': bestparamarr['weights'], 'time elapsed (secs)': t1t0,
                                'total traffic (bytes)': totaltraffic, 'inflow speed (bytes/sec)': receivespeed,
                                'outflow speed (bytes/sec)': sendspeed, 'memory usage (bytes)': sumcurrentusage}
                ...
                if model == 'rf':
                    datapar8 = {'model':'rf', 'number of partitions': n, 'validation accuracy': mean_accuracy,
                                'test accuracy': mean_testaccuracy, 'paramater 1': bestparamarr['criterion'],
                                'parameter 2': bestparamarr['max_depth'], 'parameter 3': bestparamarr['n_estimators'], 'time elapsed (secs)': t1t0,
                                'total traffic (bytes)': totaltraffic, 'inflow speed (bytes/sec)': receivespeed,
                                'outflow speed (bytes/sec)': sendspeed, 'memory usage (bytes)': sumcurrentusage}
